...
void myFloatFreeFunct(std::unique_ptr<float>& value)
{
    float& ft3 = *value;
    ft3 = ft3 + 7.0f;
}
...
void myDoubleFreeFunct(std::unique_ptr<double>& value)
{
    double& dt3 = *value;
    dt3 = dt3 + 6.0;
}
...
void myIntFreeFunct(std::unique_ptr<int>& value)
{
    int& it3 = *value;
    it3 = it3 + 5;
}
...
void part4()
{
    ...
    p3.multiply(static_cast<float>(it2)); 
    p3.toString();   
    std::cout << "---------------------\n" << std::endl;
}
